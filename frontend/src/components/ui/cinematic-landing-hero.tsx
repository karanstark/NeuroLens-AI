...
export function CinematicHero({ 
  ...
  tagline2 = "not just the data.",
  cardHeading = "Healthcare intelligence, redefined.",
  cardDescription = <><span className="text-white font-semibold">NeuroLens AI</span> transforms complex medical reports into actionable narratives. Empowering patients with structured insights, precise tracking, and beautiful visual timelines.</>,
  metricValue = 98,
  metricLabel = "Health Score",
  ctaHeading = "Decode your health.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set([".hero-text-wrapper"], { autoAlpha: 0, y: 60, x: 0, scale: 0.85, filter: "blur(20px)", rotationX: -20 });
      gsap.set(".main-card", { y: window.innerHeight + 200, autoAlpha: 1 });
      gsap.set([".card-left-text", ".card-right-text", ".mockup-scroll-wrapper", ".floating-badge", ".phone-widget"], { autoAlpha: 0 });
      gsap.set(".cta-wrapper", { autoAlpha: 0, x: 0, scale: 0.8, filter: "blur(30px)" });

      const introTl = gsap.timeline({ delay: 0.5 });
      introTl
        .to(".hero-text-wrapper", { duration: 1.8, autoAlpha: 1, y: 0, x: 0, scale: 1, filter: "blur(0px)", ease: "expo.out" })
        .to(".hero-text-wrapper", { duration: 1.5, y: -150, scale: 0.85, ease: "power3.inOut" }, "+=0.8")
        .to(".cta-wrapper", { 
          duration: 1.2, 
          autoAlpha: 1, 
          y: 80, 
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 will-change-transform transform-style-3d">
        <h1 className="text-3d-matte text-4xl md:text-6xl lg:text-[5rem] font-bold tracking-tight text-center w-full max-w-5xl mx-auto leading-[1.1]">
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-10 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-10">
          <Link to="/analysis" aria-label="Analyze Report" className="btn-modern-light flex flex-col items-center justify-center px-10 py-5 rounded-[1.5rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            <div className="text-center">
              <div className="text-[10px] font-bold tracking-[0.2em] text-neutral-500 uppercase mb-1">Start Your</div>
              <div className="text-2xl font-black leading-none tracking-tighter">Report Analysis</div>
            </div>
          </Link>
          <Link to="/demo" aria-label="View Health Demo" className="btn-modern-dark flex flex-col items-center justify-center px-10 py-5 rounded-[1.5rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <div className="text-center">
              <div className="text-[10px] font-bold tracking-[0.2em] text-neutral-400 uppercase mb-1">Experience the</div>
              <div className="text-2xl font-black leading-none tracking-tighter">Interactive Demo</div>
            </div>
          </Link>
        </div>
      </div>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Health Twin</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">NL</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">New report analyzed</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Health Trend</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Projected improvement</p>
                  </div>
                </div>
